![point locations of street view images](docs/images/roads.png)
...
### Get grid points, (lat, lon) pairs, from admin shape file (step 3)
...
1. Right Click > Export layer > as.csv
...
### Get street view metadata (step 4)
