...
| `web_app`          | This repository contains all the code needed to build a web-app to survey user pairwise image ratins. | [web_app](docs/2.web_app.mdweb_app.md) | Build database, back-end and front-end. Dockerise and host using kubernetes. |
